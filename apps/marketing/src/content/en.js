// ---------------------------------------------------------------------------
// English copy (default / fallback locale). All site copy lives in
// src/content/{en,fi,sv}.js — edit text freely without touching layout code.
// Keep this file's shape identical across all three locales.
// ---------------------------------------------------------------------------
...
export default {
  ...
  UI: {
    heroEyebrow: "structural health monitoring · finland",
    problemEyebrow: "the problem",
    solutionEyebrow: "the solution",
    whyFinlandEyebrow: "why finland · why ice",
    whoForEyebrow: "who it serves",
    teamEyebrow: "the crew",
    contactEyebrow: "start here",
    deliveryEyebrow: "how you get it",
    pricingEyebrow: "pricing",
    liveConditionBadge: "live condition",
    contactSuccess: "Thanks — your message has been sent. We'll be in touch.",
    contactError:
      "Something went wrong. Please try again or email us directly.",
    contactAriaLabel: "Contact form",
    readMore: "Read more",
    loading: "Loading…",
    postNotFoundTitle: "Not found",
    postNotFoundText: "That article doesn't exist or isn't published yet.",
    backToNews: "Back to news",
    mainNavLabel: "Main navigation",
    homeAriaLabel: "vellamo — home",
    openMenu: "Open menu",
  ...
  NOT_FOUND: {
    eyebrow: "404",
    title: "Lost beneath the surface.",
    text: "This page doesn't exist — it may have moved, or the link was mistyped. Let's get you back to solid ground.",
    home: "Back to home",
    contact: "Contact us",
  },
  ...
  TEAM: {
    ...
    title: "Team",
    intro:
      "A founding team of structural and construction engineers relocating to Finland — with software leadership to turn the science into a service.",
    why: "Hamidreza pairs structural engineering with CEO experience to run the company. Mohsen brings earthquake-engineering research depth and performance-based design to R&D. Bahareh has kept EPC megaprojects on schedule and does the same for our product and pilots. Farjad, our Toronto-based CTO, turns the science into software customers can use. Marine and ice physics depth is secured through the planned VTT/Aalto research partnership and a specialist hire — the first technical priority after incorporation.",
    members: [
      {
        key: "hamidreza",
        name: "Hamidreza Salmanmohajer",
        role: "Co-founder & CEO",
        bio: "M.Sc. Civil Engineering (Structures). Structural engineer and construction manager on delivered projects; previously co-founder and CEO of Quaketant, a crisis-management startup. Leads Vellamo's execution, operations in Finland, fundraising and overall accountability.",
        photo_url: "/team/hamidreza.jpg",
      },
      {
        key: "mohsen",
        name: "Mohsen Kavian",
        role: "Co-founder, COO & R&D Engineer",
        bio: "M.Sc. Earthquake Engineering (IUST). Structural designer and performance-based design specialist (FEMA-certified webinar series); published researcher; previously COO of Quaketant. Runs operations and the structural R&D behind the digital twin.",
      ...
      },
      {
        ...
        bio: "PMP · M.Sc. Construction Management. Project Control Manager on EPC megaprojects — dams, refineries and petrochemical plants — with Primavera P6 across head-office and site teams. Owns product delivery and keeps pilots on schedule.",
      ...
      },
      {
        ...
        name: "Farjad",
        role: "CTO",
        bio: "Toronto-based technology entrepreneur with 22 years in software; built two programming companies and founded North Road AI. Leads platform and dashboard development: the sensor data pipeline, the digital-twin platform and the customer dashboard.",
      },
    ],
  },
